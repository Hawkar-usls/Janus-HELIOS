...
This license applies to source code, documentation, schemas, protocols, designs, visual assets, demo logic, routing manifests and other copyrightable material in this repository (the **Materials**), except where a file expressly states another license.

## 2. Evaluation permission

You are granted a limited, revocable, non-exclusive, non-transferable and non-sublicensable right to access, inspect, run and internally evaluate the Materials solely to assess a potential research, pilot, partnership, licensing, investment, procurement or commercial relationship with the copyright holder.

## 3. No commercial or production rights
