...
const [robots, sitemap, opportunityText, discoveryHtml] = await Promise.all([
...
for (const entry of ['agents.json', 'agents.txt', 'llms.txt', 'opportunity.json', 'discovery.html', 'PROJECT_STATUS.json']) {
...
console.log('HELIOS web/RAG + technology deal-scout discovery invariants: PASS');
