...
assert.equal(cfg.patch_level,'SMOOTH_FLOW_1');
...
assert.match(source,/PATCH_LEVEL = 'SMOOTH_FLOW_1'/);
...
assert.match(source,/helios-stellar-planet-flow/);
...
assert.match(docs,/SMOOTH_FLOW_1/);
...
console.log('stellar navigator smooth-flow invariants: PASS');
